/***
   ...
   *  @description
    *
    *	实验平台：反客STM32F103RCT6核心板 （型号：FK103M2）+ 1.30寸液晶模块（型号：SPI130M1-240*240）
...
void LCD_SPI_Config(void)
{
    ...
    SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_4; // 4分频，此时SPI时钟为18MHz
...
void LCD_DisplayNumber(uint16_t x, uint16_t y, int number, uint8_t len)
{
